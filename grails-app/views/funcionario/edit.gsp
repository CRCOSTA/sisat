...
<body>
	...
	<div id="breadcrumb">
		<a href="/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">funcion&aacute;rio</a>
		<g:link action="list" class="tip-bottom">Pesquisa</g:link>
		<g:link action="show" id="${funcionarioInstance.id}" class="tip-bottom">Visualiza&ccedil;&atilde;o</g:link>
			...
			<div class="span12">
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<g:form action="update" method="post" class="form-horizontal" novalidate="novalidate" name="createFuncionario">
