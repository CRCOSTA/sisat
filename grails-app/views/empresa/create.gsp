...
<body>
	...
	<div id="breadcrumb">
		<a href="/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Empresas</a> <a href="#" class="current">Cadastro</a>
	</div>
			...
			<g:hasErrors bean="${empresaInstance}">
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<g:form action="save" method="post" class="form-horizontal" novalidate="novalidate" name="createEmpresa">
